...
urlpatterns = [
    ...
    url(r'^profile/(?P<email>.+)/$', accounts_views.UserRetrieveUpdateView.as_view(), name='user_detail'),
    url(r'^profile-name/(?P<email>.+)/$', accounts_views.UserNameUpdateView.as_view(), name='user_name_update'),
    url(r'^profile-avatar/(?P<email>.+)/$', accounts_views.UserAvatarUpdateView.as_view(), name='user_avatar_update'),
